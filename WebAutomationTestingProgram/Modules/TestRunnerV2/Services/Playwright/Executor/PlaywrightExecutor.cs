...
namespace WebAutomationTestingProgram.Modules.TestRunnerV2.Services.Playwright.Executor
{
    ...
    {   
        ...
        public static void InitializeStaticVariables(IComponentContext componentContext)
        {
            ...
            string jsonContent = System.IO.File.ReadAllText(actionsFilePath);
        ...
        public PlaywrightExecutor(Context context, IReaderFactory readerFactory, IHubContext<TestHub> hubContext)
        {
            ...
            _envVars["delay"] = _request.StepDelay.ToString();
